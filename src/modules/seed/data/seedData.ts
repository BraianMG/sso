  ...
  users: [
    {
      ...
      password: bcrypt.hashSync('Admin1@example', SALT_OR_ROUNDS),
      isActive: true,
      roles: [adminRole],
    },
    {
      ...
      fullName: 'Usuario 1',
      password: bcrypt.hashSync('User1@example', SALT_OR_ROUNDS),
      isActive: true,
      roles: [userRole],
    },
    {
      ...
      fullName: 'Usuario 2',
      password: bcrypt.hashSync('User2@example', SALT_OR_ROUNDS),
      isActive: true,
      roles: [userRole],
    },
  ],
